...
export default function Home() {
  ...
  return (
    <>
      ...
      <div
        className={clsx(
          "p-3 opacity-0 text-center w-1/2 m-auto leading-loose",
          inView && "anim-text"
        )}
        ref={ref}
      >
      ...
      <section>
        ...
        <div className="gap-40 home-vintage my-3 px-4">
      ...
      <section className="about px-4 ">
        ...
        <div className="flex gap-8 w-full">
          <figure className="p-4 ratio-3-4"><img src="./gyu.jpg" alt="corperative" /></figure>
